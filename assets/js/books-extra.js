...
(function () {
  ...
  if (Array.isArray(window.ALL_BOOKS)) {
    ...
    var corrections = {
      ...
      105: 417,   /* روضة المحبين لابن القيم: كان 707 (لا صلة له)؛ اختيرت طبعة عطاءات العلم اتساقًا مع باقي كتب المؤلف في هذه المكتبة */
      51: 197,    /* زاد المعاد لابن القيم: كان 172 (لا صلة له)؛ اختيرت طبعة عطاءات العلم لنفس السبب */
      144: 199,   /* شرح منازل السائرين (=مدارج السالكين) لابن القيم: كان 171 (كتاب مختلف تمامًا)؛ اختيرت طبعة عطاءات العلم لنفس السبب */
      31: 12096,  /* منهاج الطالبين للنووي: كان 317 (لا صلة له بالكتاب) */
      65: 23634,  /* معاني القرآن للفراء: كان 433 (رقم صفحة داخل كتاب آخر، وليس معرّف كتاب) */
      49: 11496,  /* إعلام الموقعين لابن القيم: كان 55 (لا صلة له بالكتاب) */
      73: 21712   /* الكامل في التاريخ لابن الأثير: كان 198 (لا صلة له)؛ اختيرت طبعة تدمري (١٠ أجزاء)، الأشهر والأكثر استخدامًا */
    };
