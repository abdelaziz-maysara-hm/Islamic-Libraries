  ...
  function run() {
    if (path.indexOf('fatawa') !== -1) {
      load(root + 'assets/js/fatawa-expand-old.js')
        ...
        .then(function () { return load(root + 'assets/js/fatawa-expand-old7.js'); })
        .then(function () { return load(root + 'assets/js/fatawa-expand-old8.js'); })
        .then(function () { return load(root + 'assets/js/fatawa-expand-old9.js'); })
        .then(function () { return load(root + 'assets/js/fatawa-expand-old10.js'); })
        .then(function () { return load(root + 'assets/js/fatawa-expand-old11.js'); })
        ...
        .then(function () { return load(root + 'assets/js/fatawa-extra4.js'); })
        .then(function () { return load(root + 'assets/js/fatawa-extra5.js'); })
        .then(function () { return load(root + 'assets/js/fatawa-extra6.js'); })
        .then(function () { return load(root + 'assets/js/fatawa-extra7.js'); })
        .then(function () { return load(root + 'assets/js/fatawa-extra8.js'); })
        ...
        .then(function () { if (window.ILFatawaPage) window.ILFatawaPage.refresh(); })
        .catch(function () { updateFatwaCount(); if (window.ILFatawaPage) window.ILFatawaPage.refresh(); });
    }
